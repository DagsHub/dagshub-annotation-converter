...
from dagshub_annotation_converter.refactored.formats.cvat.context import parse_image_tag, CVATContext
from dagshub_annotation_converter.refactored.ir.image import IRPoseAnnotation, IRPosePoint, NormalizationState
